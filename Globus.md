...
This guide documents the process for downloading HuBMAP datasets to specific storage locations using `hubmap-clt` and Globus Connect Personal. And some commond `Rabit Holes`.
...
### ✅ 2. Install and Configure Globus Connect Personal
...
```
~/,0,1
/teradata/username/deepcell-experiments-data,0,1
```
...
### ✅ 4. Transfer Data using HuBMAP CLI
