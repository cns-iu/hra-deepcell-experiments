...
def main():
    ...
    # Configuration
    INPUT_PATH = "/u/sbdubey/CLI_HUBMAP/hra-deepcell-experiments/scripts/spleen-codex-ufl/data/deepcell_spleen.csv"
    OUTPUT_PATH = "/u/sbdubey/CLI_HUBMAP/hra-deepcell-experiments/scripts/spleen-codex-ufl/data/descendant_hubmapID_spleen_01.csv"
