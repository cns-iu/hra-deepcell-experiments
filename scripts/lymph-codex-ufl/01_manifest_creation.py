...
def main():
    ...
    # Configuration
    CSV_PATH = '/u/sbdubey/CLI_HUBMAP/hra-deepcell-experiments/scripts/lymph-codex-ufl/data/descendant_hubmapID_lymph_01.csv'
    OUT_DIR = "/u/sbdubey/CLI_HUBMAP/hra-deepcell-experiments/scripts/lymph-codex-ufl/data"
    MANIFEST_FILENAME = "manifest_lymph.txt"
