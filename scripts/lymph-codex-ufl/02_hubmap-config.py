...
def main():
    ...
    # Configuration
    INPUT_ROOT = "/teradata/hra_data/deepcell-experiments-data/lymph-codex-ufl/data-original/"
    OUTPUT_ROOT = "/teradata/hra_data/deepcell-experiments-data/lymph-codex-ufl/input-data/"
