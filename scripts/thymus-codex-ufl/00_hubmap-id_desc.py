...
def main():
    ...
    # Configuration
    INPUT_PATH = "/u/sbdubey/CLI_HUBMAP/hra-deepcell-experiments/scripts/thymus-codex-ufl/data/deepcell_thymus.csv"
    OUTPUT_PATH = "/u/sbdubey/CLI_HUBMAP/hra-deepcell-experiments/scripts/thymus-codex-ufl/data/descendant_hubmapID_thymus_01.csv"
