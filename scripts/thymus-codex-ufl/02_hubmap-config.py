...
def main():
    ...
    # Configuration
    INPUT_ROOT = "/teradata/hra_data/deepcell-experiments-data/thymus-codex-ufl/data-original/"
    OUTPUT_ROOT = "/teradata/hra_data/deepcell-experiments-data/thymus-codex-ufl/input-data/"
