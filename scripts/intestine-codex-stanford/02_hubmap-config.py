...
def main():
    ...
    # Configuration
    INPUT_ROOT = "/teradata/hra_data/deepcell-experiments-data/intestine-codex-stanford/data-original/"
    OUTPUT_ROOT = "/teradata/hra_data/deepcell-experiments-data/intestine-codex-stanford/input-data/"
